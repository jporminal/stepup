  ...
  data: function data() {
    return {
      ...
      camps: [{
        ...
        to: '' //to: {name: 'MidtermPerformingArts'},
                ...
                [
                  _c("v-card", {
                    ...
                    attrs: {
                      ...
                      width: _vm.$vuetify.breakpoint.mdAndUp ? "500" : "325",
                      height: _vm.$vuetify.breakpoint.mdAndUp ? "500" : "325",
                      to: camp.to
                    }
                  })
                ],
