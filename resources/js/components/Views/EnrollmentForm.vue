          ...
          <div v-if="$vuetify.breakpoint.mdAndUp">
            <v-stepper v-model="$store.state.Enrollments.steps">
              <v-stepper-header>
                ...
                <v-stepper-step
                  step="3"
                  :complete="$store.state.Enrollments.steps > 3 ? true : false"
                >
...
export default {
  ...
  components: {
    my_location: () => import("../Components/Form/Enrollment/Location"),
    my_student: () => import("../Components/Form/Enrollment/Student"),
    my_parent: () => import("../Components/Form/Enrollment/Parent"),
  },
  ...
  data() {
    return {
      ...
      seo: {
        ...
        description:
          "We offer a great selection of Dance and Fitness classes to cater for all ages and abilities. We offer trial classes and afterwards our teachers will be happy to give you feedback, this will ensure we find a suitable class for you or your child.s",
  ...
  metaInfo() {
    return {
      ...
      meta: [
        ...
        { property: "og:url", content: this.seo.site + "enrollment-form" },
        {
          property: "og:image",
        ...
        { name: "twitter:site", content: this.seo.site + "enrollment-form" },
