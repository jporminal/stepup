    ...
    <v-card-text>
      <v-row justify="center">
        <v-col cols="12" md="3">
          <v-card flat>
            <v-img
              src="/img/camps/Midterm/2022/feb-camp.jpg"
              alt="MidTerm camps"
            />
          </v-card>
        </v-col>
        <v-col cols="12" md="7" lg="5">
          <p class="display-1">World Tour Multi-Skills Camp</p>
      ...
      this.$store.state.winter.winter_workshop_selected.forEach((product) => {
            ...
            var cart = {
              product_id: this.$store.state.winter.winter_workshop_filter
                .service_id.id,
              product_image: "february-camp.jpg",
