    ...
    <v-card-text>
      <v-row justify="center">
        <v-col cols="12" md="3">
          <v-card>
            <v-img
              src="/img/camps/Spring/2021/down-the-nile-river.jpg"
              alt="Down The River Nile"
            />
          </v-card>
        </v-col>
        <v-col cols="12" md="5">
          <p class="display-1">Down The River Nile</p>
          <p class="title">8-30AM - 3:30PM</p>
          <p class="title">3.5yrs - 10yrs</p>
          <v-autocomplete
            label="Select Age"
...
export default {
      ...
      this.$store
        ...
        .then((result) => {
          ...
          prods.forEach((product) => {
            ...
            var cart = {
              product_id: this.$store.state.winter.winter_workshop_filter.service_id.id,
              product_image: "down-the-nile-river.jpg",
              product_name: this.$store.state.winter.winter_workshop_filter.service_id.product,
              product_category: "Service",
              product_quantity: product.quantity,
              product_xero: this.$store.state.winter.winter_workshop_filter.service_id.xero,
              notes: "",
              type: "Camps",
              product_option: {
  ...
  metaInfo() {
    return {
      title: "Camps",
      titleTemplate: "%s - Down The River Nile",
      htmlAttrs: {
        lang: "en",
      },
    };
